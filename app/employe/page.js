...
const page = () => {
  ...
  return (
      ...
      <div className="flex flex-col items-center">
        <div className="pb-10">
          <p className="font-bold text-3xl text-[#333333]">Trending on Internshala 🔥</p>
        </div>
      ...
      <div className="w-11/12 mx-auto my-20">
        ...
        <div className="description flex justify-between items-center">
          <p className="text-base font-semibold text-gray-700">Hire from a pool of skilled candidates</p>
          <p id="view_more">
        ...
        <div className="grid grid-cols-6 gap-4 mt-4">
          <div className="card gap-2 font-semibold flex flex-col items-center">
            <div className='rounded-md max-h-28 object-contain object-top overflow-hidden'>
              <img
